...
public class TaskFourCaseSix {
    public static void main(String[] args) {
        ...
        if (year % 400 == 0 || (year % 100 != 0) && (year % 4 == 0)) {
            System.out.println("количество дней в году: " + leapYear + " - високосный год");
        } else {
            System.out.println("количество дней в году: " + notALeapYear + " - обычный год");
        }
    }
}
