...
public class TaskSixCaseOne {

    public static void main(String[] args) {
        new TaskSixCaseOne.LuxuriousCar().printlnDesire();
        new TaskSixCaseOne.CheapCar().printlnDesire();
        new TaskSixCaseOne.Ferrari().printlnDesire();
        new TaskSixCaseOne.Lanos().printlnDesire();
    }
